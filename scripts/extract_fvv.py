...
base_paths = ["eagle_video"]

for base_path in base_paths:
    frame_folders = sorted([f for f in os.listdir(base_path) if f.startswith('colmap') and os.path.isdir(os.path.join(base_path, f))])
    ...
    for folder in frame_folders:
        ...
        addition_3dgs_source_path = os.path.join(base_path, folder, 'point_cloud', 'iteration_750', 'added', 'point_cloud.ply')
